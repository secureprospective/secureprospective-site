...
Modern is a derivative work released under the GNU General Public
...
The `wallpaper/Modern/` package uses
...
|-------|--------------|--------|---------|-------|
| Dark image | Mahmoud Ramadan | <https://www.pexels.com/photo/31622984/> | Pexels License | `wallpaper/Modern/contents/images_dark/` |
| Light image | Ace Visuals Co | <https://www.pexels.com/photo/19931186/> | Pexels License | `wallpaper/Modern/contents/images/` |

## Icon Pack Sources

The `icons/modern/` icon theme is a curated derivative work.
