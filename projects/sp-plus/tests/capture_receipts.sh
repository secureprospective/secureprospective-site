...
failures=0
capture org.secureprospective.spplus.windows11.dark  windows-dark      --layout || failures=$((failures + 1))
capture org.secureprospective.spplus.windows11.light windows-light     --layout || failures=$((failures + 1))
