...
| E3 | Printing | knowledge/advisor-help/printer.md | VERIFIED | verified: live VM CUPS active/enabled, Print Settings desktop entry and test-page template, with no configured printer; image same; Welcome checks a usable CUPS printer then submits exactly one test-page job; deployed Fin printer skill inspects first and requires approval before repair. No physical-printer test performed. Drift: prior page was a diagnostic-policy stub, not everyday printing help. |
