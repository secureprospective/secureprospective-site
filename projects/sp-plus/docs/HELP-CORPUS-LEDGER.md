...
| E7 | Video calls, camera and microphone | knowledge/advisor-help/video-calls.md | VERIFIED | verified: live VM PipeWire/WirePlumber/Pulse services active and no /dev/video device; image ships Brave, PipeWire, WirePlumber and KDE portal with no Zoom/Teams/Jitsi/Webex desktop app; deployed Fin video-call prompt checks devices, selection, permission and offers a test recording. No physical camera, live call, capture, or screen-share test performed. |
